	...
	<div class="span5">
		<div class="logo">
			<a href="./京华亿家/index.htm">
				...
				<%-- <img src="${pageContext.request.contextPath}/images/logo.png" alt="华中师大"/> --%>
			</a>
		</div>
	</div>
	<div class="span9">
					...
					<ul class="tab">
						...
						<ul class="tabContent" style="display: block;">
							<s:iterator value="HotList">
									<li>
										<a target="_blank" href="${pageContext.request.contextPath}/product_findByPid?pid=<s:property value="pid"/>">
						...
						<ul class="tabContent" style="display: none;">
									<li>
										<a target="_blank"><img src="./Mango商城 - Powered By Mango Team_files/c5b1b396-181a-4805-9e68-9b400d71f91e-thumbnail.jpg"  style="display: block;"/></a>
									</li>
									<li>
										<a  target="_blank"><img src="./Mango商城 - Powered By Mango Team_files/4107e1ce-5e7c-4941-bc0f-718f35ba14cd-thumbnail.jpg"  style="display: block;"/></a>
									</li>
									<li>
										<a  target="_blank"><img src="./Mango商城 - Powered By Mango Team_files/6f8ae4bf-cbd3-41c7-aa22-0fe81db6add4-thumbnail.jpg"  style="display: block;"/></a>
									</li>
									<li>
										<a target="_blank"><img src="./Mango商城 - Powered By Mango Team_files/3d835c07-08c5-46d7-912d-adcd41f8c8e6-thumbnail.jpg" style="display: block;"/></a>
									</li>
									<li>
					...
					<ul class="tab">
						 ...
						 <ul class="tabContent" style="display: block;">
						 	<s:iterator value="newList">
								<li>
									<a  target="_blank" href="${pageContext.request.contextPath}/product_findByPid?pid=<s:property value="pid"/>"><img src="${pageContext.request.contextPath}/<s:property value="image"/>" data-original="http://storage.shopxx.net/demo-image/3.0/201301/4a51167a-89d5-4710-aca2-7c76edc355b8-thumbnail.jpg" style="display: block;"></a>
								</li>
							</s:iterator>		
						</ul>
						<ul class="tabContent" style="display: none;">
...
<div class="container footer">
	...
	<div class="span24">
		<div class="copyright">Copyright © 2005-2017 Mango商城 版权所有</div>
	</div>
</div>
</body></html>