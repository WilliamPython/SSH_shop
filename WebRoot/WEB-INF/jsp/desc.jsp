...
<div class="container productContent">
		<div class="span6">
			...
			<s:iterator value="CategoryList" var="c">
						...
						<s:iterator value="#c.categoryseconds" var="cs">
							<dd>
								<a href="${pageContext.request.contextPath }/product_findByCsid?csid=<s:property value="#cs.csid"/>&page=1">
		...
		<form id="cartItemForm" action="${pageContext.request.contextPath }/cart_addCartItem" method="post" >
