...
<script type="text/javascript">
 ...
 function checkUserName(){
	...
	$("#DoesUserNameExit").load("${pageContext.request.contextPath}/user_checkUserName.action?time="+new Date().getTime(),{'username':username});
 }
 function change(){
						...
						<table>
							...
							<tr>
								...
								<td>
									...
									<span id="DoesUserNameExit"><s:fielderror fieldName="username"/></span>
								</td>
							</tr>
							<tr>
								<th>
							...
							<tr>
								...
								<td>
									...
									<tr>
										...
										<td>
											<input type="text" name="phone" id="phone" class="text" maxlength="30"><span><s:fielderror fieldName="phone"/></span>
										</td>
									</tr>
								    <tr>
										<th>
										...
										<td>
											<input type="text" name="addr" id="addr" class="text" maxlength="200"><span><s:fielderror fieldName="addr"/></span>
										</td>
									</tr>
								<tr>
									<th>
