...
<div class="container cart">
		<div class="span24">
		 <s:if test="#session.cart==null || #session.cart.cartItems.size()==0">
		    <div align="center">
				<img src="${pageContext.request.contextPath }/images/cart.png" alt="购物车为空，快去购物吧！" width="40%" height="15%"/>
				  购物车为空，快去购物吧！<br/>
			</div>
			<div/>
		</s:if>
					...
					<tr>
					   ...
					   <s:iterator value="#session.cart.cartItems">
						<tr>
							...
							<td>
								<a target="_blank" href="${pageContext.request.contextPath}/product_findByPid?pid=<s:property value="product.pid"/>"> <s:property value="product.pname"/></a>
							</td>
							<td>
							...
							<td>
								<a href="${pageContext.request.contextPath}/cart_removeCartItem?pid=<s:property value="product.pid"/>" class="delete">删除</a>
							</td>
						</tr>
						</s:iterator>
					</tbody>
